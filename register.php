...
if(empty(trim($_POST["username"]))){
    ...
    $username_err = "Username harus minimal 6 karakter.";
} else {
    ...
    if($stmt = mysqli_prepare($con, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_stmt_num_rows($stmt) == 1){
                $username_err = "Nama pengguna ini sudah dipakai.";
            } else{
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($con, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "<script>alert('Registrasi berhasil! Anda akan diarahkan ke halaman login.'); window.location.href='login.php';</script>";
            } else{
