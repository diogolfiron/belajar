...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_father, u_ktp, u_birthday, u_gender, u_email, u_phone, u_state, u_dist, u_village, u_police, u_pincode, u_mother, u_family, staff_id,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_ktp','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_village','$u_police','$u_pincode','$u_mother','$u_family','$u_staff_id','$image',NOW())";
...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="images/Logo.jpg" alt="" width="125px" ></a><br><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="images/Logo.jpg" width="200px" height="150px" alt=""></center>
...
<input type="text" class="form-control" name="user_KTP" maxlength="12" placeholder="Enter 12-digit No KTP ">
</div>
</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='ktp'>KTP No.</label>
		<input type='text' class='form-control' name='user_KTP' maxlength='12' placeholder='Enter 12-digit No KTP. ' value='$KTP'>
		</div>
		</div>
